...
public interface ResponseUtil {
     ...
     * with an {@link org.springframework.http.HttpStatus#OK} status, or if it's
     * empty, it returns a {@link org.springframework.http.ResponseEntity} with
    ...
    /**
     * Wrap the optional into a {@link org.springframework.http.ResponseEntity}
     * with an {@link org.springframework.http.HttpStatus#OK} status with the
