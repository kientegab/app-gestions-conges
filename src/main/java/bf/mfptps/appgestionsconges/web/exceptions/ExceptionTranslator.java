...
import bf.mfptps.appgestionsconges.service.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
            bf.mfptps.appgestionsconges.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
            bf.mfptps.appgestionsconges.service.InvalidPasswordException ex,
            NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleCustomException(
            bf.mfptps.appgestionsconges.service.CustomException ex,
            NativeWebRequest request
    ) {
